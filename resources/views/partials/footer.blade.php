        ...
        <div class="max-w-6xl mx-auto px-5 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Beranda</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Profil Sekolah</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Program Akademik</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Fasilitas</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Berita & Artikel</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Galeri</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Kontak</span></a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 mb-6">
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>PPDB Online</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>E-Learning</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Portal Siswa</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Perpustakaan Digital</span></a></li>
                        <li><a href="#" class="text-blue-100 hover:text-amber-400 transition-colors text-sm flex items-center space-x-2"><i class="fas fa-chevron-right text-xs"></i><span>Konseling Online</span></a></li>
                    </ul>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            <a href="#" class="w-10 h-10 bg-blue-700 hover:bg-amber-500 rounded-full flex items-center justify-center transition-colors group">
